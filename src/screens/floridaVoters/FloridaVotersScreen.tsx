...
import {
  ...
  getFilteredVoters,
} from '../../services/api_services/FloridaVotersService';
...
const FloridaVotersScreen: React.FC = () => {
  const route =
    useRoute<RouteProp<FloridaVotersRouteParams, 'floridaVoters'>>();
  ...
  const [columns, setColumns] = useState<ColumnDef[]>([
    ...
    {
      key: 'CountyCommissionDistrict',
      label: 'County Dist',
      width: 100,
      visible: true,
    },
    {
      key: 'SchoolBoardDistrict',
      label: 'School Dist',
      width: 100,
      visible: true,
    },
  ...
  const [selectedCountyDistrict, setSelectedCountyDistrict] =
    useState<string>('');
    ...
    const fetchFilterOptions = async () => {
      ...
      try {
        ...
        const cityList = citiesData
          ...
          .filter(
            (city: string) => city && city.trim() !== '' && city !== '<select>',
          )
          .sort();
  ...
  const getCellValue = (voter: VoterItem, columnKey: string): string => {
    ...
    if (columnKey === 'DaytimePhoneNumber') {
      return formatPhone(
        voter.DaytimeAreaCode,
        voter.DaytimePhoneNumber,
        voter.DaytimePhoneExtension,
      );
    }
  ...
  return (
    <SafeAreaView style={globalStyles.safeAreaContainer}>
      ...
      <View style={styles.filterContainer}>
        ...
        <TouchableOpacity
          ...
          <Text
            style={[
              styles.dropdownButtonText,
              !selectedCountyDistrict && styles.placeholderText,
            ]}>
        ...
        <TouchableOpacity
          ...
          <Text
            style={[
              styles.dropdownButtonText,
              !selectedSchoolDistrict && styles.placeholderText,
            ]}>
      ...
      {renderDropdown(
        ...
        countyDistricts,
        handleCountyDistrictSelect,
        selectedCountyDistrict,
        'Select County Commission District',
      )}
      {renderDropdown(
        showSchoolDropdown,
        () => setShowSchoolDropdown(false),
        schoolDistricts,
        handleSchoolDistrictSelect,
        selectedSchoolDistrict,
        'Select School Board District',
      )}
                ...
                <>
                  ...
                  <View style={styles.tableWrapper}>
                    <ScrollView
                      ...
                      <View
                        style={{
                          width: Math.max(totalTableWidth + 20, SCREEN_WIDTH),
                        }}>
                        {/* Table Header */}
      ...
      <View style={styles.disclaimerContainer}>
        <Text style={styles.disclaimerText}>
          The information provided has been obtained from the Florida Division of
          Elections and is updated every 30 days. If you notice any
          discrepancies, please notify our office so we can report them to the
          Division immediately. Please note that we are not liable for any
          inaccuracies, as this data is not maintained by our office. All
